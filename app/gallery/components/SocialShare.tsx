  ...
  const socialPlatforms = [
    {
      ...
      color: 'bg-[#1877F2] hover:bg-[#0b5fcc]',
    ...
    },
    {
      ...
      color: 'bg-[#E60023] hover:bg-[#c30c22]',
  ...
  return (
    <div className="relative">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            className="absolute right-0 mt-2 bg-white rounded-lg shadow-lg overflow-hidden z-20 w-60"
            ...
            <div className="p-2">
              {socialPlatforms.map((platform, index) => (
                <button
                  ...
                  className={`w-full flex items-center space-x-3 px-4 py-3 rounded-md text-white ${platform.color} my-1 transition-colors`}
                >
                  {platform.icon}
