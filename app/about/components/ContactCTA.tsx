...
export default function ContactCTA() {
  ...
  return (
    <section id="contact-cta" className="py-16 md:py-24 bg-primary relative overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        >
          ...
          >
            Создайте свой индивидуальный стиль вместе с нами
          </motion.h2>
          ...
          >
            Наша команда профессионалов готова воплотить в жизнь ваши самые смелые идеи. 
            Запишитесь на консультацию, и мы поможем вам создать неповторимый образ.
          </motion.p>
          ...
          >
            <Link 
              href="#contact" 
              className="bg-white text-primary px-8 py-4 rounded-md text-lg font-semibold transition-transform duration-300 hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary"
            >
