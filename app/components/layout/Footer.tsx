...
const contacts = [
  { text: CONTACTS.address, href: CONTACTS.links.address },
  { text: CONTACTS.phone, href: CONTACTS.links.phone },
  { text: CONTACTS.email, href: CONTACTS.links.email },
];
...
function SocialIcon({ type }: SocialIconProps) {
  const getHref = () => {
    switch (type) {
      case 'instagram': return CONTACTS.social.instagram;
      case 'facebook': return CONTACTS.social.facebook;
      case 'youtube': return CONTACTS.social.youtube;
      default: return '#';
    }
  };
